...
def tb():
    # os.system('cls')
    print(colorama.Fore.LIGHTRED_EX + (pyfiglet.figlet_format(
        "XinXinDangAn", font="small")))
    print(
        colorama.Fore.LIGHTRED_EX +
        "城建档案XML目录整编系统\n\nCopyright 2017-2018   四川欣兴档案管理咨询有限公司  All rights reserved.\n")
            ...
            for i in f.readlines():
                ...
                if ',' in line:
                    ...
                    try:
                        ...
                        if a[1] == '1':
                            ...
                            fo.write(
                                ...
                                (count_aj, singleprojectid, count_aj, zdjh__, ajtm, bzdw, bzrq, ajzrz, gg, jnwjqssj, jnwjzzsj, bgqx, mj, ljr, ljsj, ztc, fz, str(
                                    uuid.uuid4()).upper()))
                            ajtm_ = ''
                            test_zzy = 0
                    ...
                    if not int(a[1]) - 1 == int(test_zzy):
                        print(colorama.Fore.LIGHTRED_EX +' '*42+"终止页 {:<} 错误".format(str(test_zzy)))
                    test_zzy = a[2]
                    ...
                    try:
                        if int(ab) > 0:
                            ...
                            #try:
                            #    x.pages[0]['/Resources']['/Font']
                            #except:
                            #    print(' '*15+'%s (%s) 非双层PDF'%(wstream.name,a[0]),end='')
                            #finally:
                            #    print('\n')
                            isdouble=False
                            for i in range(len(x.pages)):
                                try:
                                    ...
                                    pass
                                    #isdouble=False
                                    #print(colorama.Fore.LIGHTGREEN_EX +' '*10+'非双层PDF   : '+"{:\u3000<30} {:>10}".format(a[0],str(count)+'.pdf'))
                                    #break
                            if not isdouble:
                                print(colorama.Fore.LIGHTGREEN_EX +' '*10+'非双层PDF   : '+"{:\u3000<30} {:>10}".format(a[0],str(count)+'.pdf'))
                        ...
                        #print(colorama.Fore.LIGHTYELLOW_EX +' '*10+'PDF文件错误 : '+"{:<10} -->    {:\u3000<30} ".format(str(count)+'.pdf', a[0]))
                        logger.error('PDF文件错误 : '+"{:<10}|{:\u3000<30} ".format(str(count)+'.pdf', a[0]))
